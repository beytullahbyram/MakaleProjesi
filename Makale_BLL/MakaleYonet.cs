...
namespace Makale_BLL
{
	...
	{
		private Repository<Makaleler> repository_makaleler = new Repository<Makaleler>();
		private BusinessLayerSonuc<Makaleler> businessLayerSonuc = new BusinessLayerSonuc<Makaleler>();
